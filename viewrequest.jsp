      ...
      <div class="mainbar">
   	...
   	<div id="#" width="560" style="margin-left:2px; margin-right:2px;">  
		...
		try{
			...
			String strQuery = "select * from request where requestto='"+uname+"' && status!='Accepted' order by dt DESC";
			...
			while ( rs.next() )
				  ...
				  <tr>
						...
						<td  width="82" valign="baseline" height="0">&nbsp;&nbsp;<a href="myfriend.jsp?username=<%=s1%>">more...</a></td>
						
						
						
						<td  width="100" valign="baseline" height="0" style="color:#000000;"align="center"><a href="updaterequest.jsp?rid=<%=i%>"><%=status%>..&nbsp;</a></td>
				  </tr>
					<%
						}
						connection.close();
