...
<head>
<title>MPMC : Register page</title>
      ...
      <div class="mainbar">
        <div class="article"><%
			...
			if(msg!=null){
				...
				%>
				<p><span style="color:#FF3300;"><%= msg%></span></p>
				<%
			}
        ...
        <div class="article">
          ...
          <div class="clr"></div>
          <form action="insertdata.jsp" method="post"  enctype="multipart/form-data">
            <ol>
              <li>
                <label for="name">Name (required)</label>
                <input type="text" id="name" name="userid" class="text" />
              </li>
               <li>
                <label for="name">Password (required)</label>
                <input type="password" id="name" name="pass" class="text" />
              </li>
              <li>
              ...
              <li>
                ...
                <input type="text" id="website" name="mobile" class="text" />
              </li>
			   <li>
                <label for="name">DOB</label>
                <input type="text" id="website" name="dob" class="text" />
              </li>
              <li>
			  ...
			  <li>
                <label for="website">Select Profile Photo</label>
                <input type="file" id="website" name="pic"  />
              </li>
              <li>
