    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <h2><span>Search Post Based On Keyword </span></h2>
          <div class="clr">
   	...
   	<div id="#" width="560" style="margin-left:2px; margin-right:2px;">  
		<form action="searchpost.jsp" method="post">
			<table border="3" width="560" style="margin-left:2px; margin-right:2px;">
				...
				<tr>
					<td align="right">Enter Key Word </td>
		...
		try{   
			...
			postname= request.getParameter("keyword");   
		...
		<%
			...
			String strQuery = "select * from images where title  LIKE '%"+postname+"%' || postto LIKE '%"+postname+"%'";
			...
			%>	
				...
				%>
				<form action="updatecmt.jsp?rfrom=sbkeyword&keyword=<%=postname%>" method="post">
